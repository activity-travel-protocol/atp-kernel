# CLAUDE.md — Activity Travel Protocol SDK

> **Read this file completely before writing any code.**  
> This is the authoritative context document for all Claude Code sessions on this repository.  
...
If you encounter a decision that appears unresolved, check `ATP_ProjectBrief_v51.docx` Section 7 (CLOSED decisions) and Section 10.5 (Open Questions) before asking Tom or Mike to decide. Many questions are already resolved. Do not reopen CLOSED decisions.
